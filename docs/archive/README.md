...
| `14-v2-next-execution-roadmap.md` | v2.2+ 功能路线图、验收标准与周进度表 | ✅ v2.2 已交付（2026-09-01），v2.3 待立项 |
| `15-v2.2-prd.md` | v2.2 范围、需求、验收标准与发布门禁 | ✅ v2.2 已交付（2026-09-01） |
| `16-v2.3-prd.md` | v2.3 Fastify 与可观测性范围、需求、验收标准与发布计划 | 📋 待立项 |
