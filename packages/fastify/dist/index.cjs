...
* ```
*/
const xltFastifyPlugin = (0, fastify_plugin.default)(xltFastify, { name: "@xlt-token/fastify" });
/**
...
exports.createFastifyContext = createFastifyContext;
Object.defineProperty(exports, 'createXltInstance', {
  enumerable: true,
  get: function () {
    return _xlt_token_core.createXltInstance;
  }
});
exports.mapXltError = mapXltError;
exports.matchPolicy = matchPolicy;
exports.mergeRouteAuthMeta = mergeRouteAuthMeta;
exports.resolveRouteAuthMeta = resolveRouteAuthMeta;
exports.resolveRouteConfigMeta = resolveRouteConfigMeta;
exports.runAuth = runAuth;
exports.shouldCheckLogin = shouldCheckLogin;
exports.xltFastifyErrorHandler = xltFastifyErrorHandler;
exports.xltFastifyPlugin = xltFastifyPlugin;