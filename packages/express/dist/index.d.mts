...
//#endregion
export { type AuthMatcher, type AuthResult, type CookieOptions, type CreateOptions, DEFAULT_XLT_TOKEN_CONFIG, type DeviceInfo, type ExpressLikeRequest, type ExpressLikeResponse, type HttpContext, MemoryStore, NotLoginException, NotLoginType, NotPermissionException, NotRoleException, NotSafeException, type RouteAuthMeta, type RouteAuthPolicy, type StpInterface, StpLogic, StpPermLogic, StpUtil, type TokenStrategy, UuidStrategy, XLT_EVENT_SINK, XLT_STP_INTERFACE, XLT_TOKEN_CONFIG, XLT_TOKEN_STORE, XLT_TOKEN_STRATEGY, type XltAuditEvent, XltError, type XltEventSink, type XltMiddlewareOptions, XltMode, XltSession, type XltTokenConfig, type XltTokenContext, type XltTokenStore, checkPermission, checkRole, checkSafe, createExpressContext, createMockHttpContext, createXltToken, ignoreAuth, matchPermission, requireLogin, resolveRouteAuthMeta, runAuth, setStpLogic, setStpPermLogic, shouldCheckLogin, syncExpressAuthState, xltErrorHandler, xltMiddleware };
