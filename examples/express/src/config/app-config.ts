...
export function createRoutePolicies(): RouteAuthPolicy[] {
  return [
    ...
    {
      match: "/permission/delete",
      permissions: { list: ["user:read", "user:delete"], mode: XltMode.AND },
    },
    {
      match: "/permission/order-create",
      permissions: { list: ["order:create"], mode: XltMode.AND },
    },
